...
> This file is the canonical source of guidelines for AI coding agents working on this project.
> Platform-specific files (CLAUDE.md, .cursorrules, .github/copilot-instructions.md, .windsurfrules, .clinerules) all mirror this content.
